# Actions on Google: Number Genie sample using Java and Google App Engine

This sample is an Action for the Google Assistant called, Number Genie. Number Genie is a number guessing game.
...
#### Build for Google Cloud Platform
    1. Follow the instructions for setting up the [Google Cloud App Engine Standard Environment](https://cloud.google.com/appengine/docs/standard/java/)
